...
export default ({
  ...
  description = "In essence, with every communication we go back to the drawing board with a fresh sheet, with all the completed work up to date, to work on the challenge in hand with a whole new perspective",
