...
import loveIllustrationImageSrc from "images/Our_client_love_us.jpg";
...
export default ({
  ...
  imageAlt = "We deliver the desired results to our clients on time on budget and it has become our norm. - Polygon3D",
  imageRounded = true,
  imageBorder = false,
  imageShadow = false,
  subheading = "Testimonials",
  heading = "Our Clients Love Us.",
  description = "We deliver the desired results to our clients on time on budget and it has become our norm.",
  textOnLeft = false,
